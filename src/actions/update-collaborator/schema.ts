...
export const updateCollaboratorSchema = z.object({
  ...
  gender: z.enum(genderValues, { required_error: "Gênero é obrigatório" }),
  maritalStatus: z.enum(maritalStatusValues, { required_error: "Estado civil é obrigatório" }),
  ...
  state: z.enum(stateValues, { required_error: "UF é obrigatória" }),
  ...
  contractType: z.enum(contractTypeValues, { required_error: "Tipo de contrato é obrigatório" }),
  workModel: z.enum(workModelValues, { required_error: "Regime é obrigatório" }),
  weeklyWorkload: z.string().min(1, "Carga horária é obrigatória"),
  salary: z.string().min(1, "Salário é obrigatório"),
  bank: z.enum(bankValues, { required_error: "Banco é obrigatório" }),
