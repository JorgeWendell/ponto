...
import { db } from "@/db";
import { colaboradoresTable, cargosTable, departamentosTable, unidadesTable } from "@/db/schema";
import { eq } from "drizzle-orm";
import { createCollaboratorSchema } from "./schema";

export async function createCollaborator(input: unknown) {
  const validated = createCollaboratorSchema.parse(input);
